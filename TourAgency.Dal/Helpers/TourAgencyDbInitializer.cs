...
namespace TourAgency.Dal.Helpers
{
    public class TourAgencyDbInitializer : DropCreateDatabaseAlways<TourAgencyContext>
    {
        ...
        protected override void Seed(TourAgencyContext db)
        {
            ...
            var customerUser1 = new ApplicationUser { UserName = "customer1@gmail.com", Email = "customer1@gmail.com", PasswordHash = new PasswordHasher().HashPassword("zxc123"), SecurityStamp = Guid.NewGuid().ToString(), };
            var customerUser2 = new ApplicationUser { UserName = "customer2@gmail.com", Email = "customer2@gmail.com", PasswordHash = new PasswordHasher().HashPassword("zxc123"), SecurityStamp = Guid.NewGuid().ToString(), };
            var customerUser3 = new ApplicationUser { UserName = "customer3@gmail.com", Email = "customer3@gmail.com", PasswordHash = new PasswordHasher().HashPassword("zxc123"), SecurityStamp = Guid.NewGuid().ToString(), };
            var customerUser4 = new ApplicationUser { UserName = "customer4@gmail.com", Email = "customer4@gmail.com", PasswordHash = new PasswordHasher().HashPassword("zxc123"), SecurityStamp = Guid.NewGuid().ToString(), };
            var customerUser5 = new ApplicationUser { UserName = "customer5@gmail.com", Email = "customer5@gmail.com", PasswordHash = new PasswordHasher().HashPassword("zxc123"), SecurityStamp = Guid.NewGuid().ToString(), };
            var customerUser6 = new ApplicationUser { UserName = "customer6@gmail.com", Email = "customer6@gmail.com", PasswordHash = new PasswordHasher().HashPassword("zxc123"), SecurityStamp = Guid.NewGuid().ToString(), };
            var customerUser7 = new ApplicationUser { UserName = "customer7@gmail.com", Email = "customer7@gmail.com", PasswordHash = new PasswordHasher().HashPassword("zxc123"), SecurityStamp = Guid.NewGuid().ToString(), };
            var customerUser8 = new ApplicationUser { UserName = "customer8@gmail.com", Email = "customer8@gmail.com", PasswordHash = new PasswordHasher().HashPassword("zxc123"), SecurityStamp = Guid.NewGuid().ToString(), };
            var customerUser9 = new ApplicationUser { UserName = "customer9@gmail.com", Email = "customer9@gmail.com", PasswordHash = new PasswordHasher().HashPassword("zxc123"), SecurityStamp = Guid.NewGuid().ToString(), };
